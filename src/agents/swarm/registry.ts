...
export const specialistRegistry: Record<string, SwarmAgentConfig> = {
  ...
  channelPartner: {
    ...
    tools: { ...fileSystemTools, ...webIntelligenceTools, ...skillTools },
    composioToolkits: ['hubspot', 'stripe'],
  },
  affiliateManager: {
    ...
    tools: { ...fileSystemTools, ...webIntelligenceTools, ...skillTools },
    composioToolkits: ['stripe', 'google_analytics'],
  },
  contractAnalyst: {
    ...
    tools: { ...fileSystemTools, ...webIntelligenceTools, ...skillTools },
    composioToolkits: ['notion', 'docusign'],
  },
  revOps: {
    ...
    composioToolkits: ['hubspot', 'stripe', 'zapier'],
  },
  ...
  blueTeamSpecialist: {
    ...
    tools: { ...fileSystemTools, ...shellTools, ...skillTools },
    composioToolkits: ['aws', 'github', 'pagerduty'],
  },
